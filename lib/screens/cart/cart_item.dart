        ...
        children: [
          ...
          Flexible(
            ...
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
                    const BorderRadius.horizontal(left: Radius.circular(15.00)),
            ...
            child: Column(
              ...
              children: [
                ...
                StoreConnector<AppState,
                        Function({required String id, required String option})>(
                    ...
                    builder: (context, changeCount) => Row(
                          children: [
                            IconButton(
                                ...
                                onPressed: () =>
                                    changeCount(id: product.id, option: 'dec'),
                            ...
                            IconButton(
                                ...
                                onPressed: () =>
                                    changeCount(id: product.id, option: 'inc'),
              ...
              children: [
                StoreConnector<AppState, dynamic>(
                  ...
                  builder: (context, remove) => IconButton(
                    icon: const FaIcon(FontAwesomeIcons.trashCan, color: kDeleteIconColor),
                    onPressed: remove,
                  ),
                ),
                Container(
                    padding: const EdgeInsets.only(right: 15, bottom: 15),
                    child: Text('${product.price} $kCurrencyUah/од', style: const TextStyle(fontSize: 17.00),),
                    /*Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        const Text(kPriceForOneItemText),
                        const SizedBox(height: 5.00,),
                        Text('${product.price} $kCurrencyUah', style: const TextStyle(fontSize: 17.00),),
                      ],
                    )*/)
              ],
            ),
